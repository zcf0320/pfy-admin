      ...
      >
            ...
            <div class="search-form">
              ...
              <!-- <div class="form-item">
                ...
                >
                  ...
                  <el-option label="可投保" :value="1"></el-option>
                  <el-option label="不可投保" :value="2"></el-option>
                </el-select>
              </div> -->
              <div class="form-item">
        ...
        >
          ...
          <el-table-column label="状态">
            <template slot-scope="scope">
              <span
                :class="'label-text ' + columnGroupStatus[scope.row.state]"
...
<script>
import { underwriteStatus, columnGroupStatus } from '@/utils/enum';
...
export default {
    ...
    btns() {
      return [
        { name: '全部', value: '' },
        {
          ...
          value: '0',
          isNumber: true,
          number: getConfirmNumber('GroupInsuranceRecord') || 0
        },
        { name: '可投保', value: '1' },
        { name: '不可投保', value: '2' }
      ];
  ...
  methods: {
    ...
    changeTime() {
      const vm = this;
      vm.filter.endTime =
        vm.filterTime[1] + 3600 * 24 * 1000 - 1000;
    ...
    getUnderwrite(pageInfo) {
      ...
      const params = {
        ...
        startTime: vm.filterTime.length ? vm.filterTime[0] : '',
        endTime: vm.filterTime.length ? vm.filterTime[1] : ''
      };
      ...
      vm.$store
        .dispatch('groupInsuranceRecord/getRecordList', params)
        .then(res => {
    ...
    exportList() {
      ...
      delete params.filterTime;
      ExportApi.getGroupInsuranceCount(params)
        .then(res => {
          if (res.data >= this.$enums.exportEmailNum) {
            ...
            this.$store
              .dispatch('groupInsuranceRecord/export', params)
              .then(res => {
                this.exportLoading = false;
    ...
    sureExport(email) {
      ...
      delete params.filterTime;
      params.email = email;
      this.$store.dispatch('groupInsuranceRecord/export', params).then(res => {
        if (!res.status) {
    ...
    // 查看详情
    lookDetails(id) {
      this.$router.push(`/insuranceRecord/groupInsuranceRecord/details/${id}`);
    },
    tabsChange(val) {
