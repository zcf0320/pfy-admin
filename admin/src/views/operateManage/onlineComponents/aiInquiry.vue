<template>
  <div class="inquiry-details-pages">
        ...
        <div class="leaving-message-info">
          ...
          <div class="leaving-message-info-item">
            ...
            <div class="leaving-message-info-item-r">
              <span
                :class="{
                  'link-skip': !!recordDetails.serviceSourceVO.serviceSourceId,
                  text: true,
                }"
          ...
          <div class="leaving-message-info-item">
            ...
            <div class="leaving-message-info-item-r">
             ...
             <div class="leaving-message-info-item-l"></div>
            <div class="leaving-message-info-item-r"
          ...
          <div v-if="recordDetails.resultMsg">
            <div class="leaving-message-info-title">
              {{ diagnoseType[recordDetails.baseMsg.diagnoseType] }}结果<span
                class="title-result"
                @click="progressModalToggle"
                >问诊过程</span
              >
            </div>
            <div class="leaving-message-info-item">
              ...
              <template  v-if="recordDetails.resultMsg.diseaseName">
...
import ChatRecordModal from '../../inquiryManage/component/chatRecordModal';
import {
  operationType,
  menuType,
  diagnoseActionType,
...
export default {
  ...
  computed: {
    createTime() {
      return this.recordDetails.baseMsg.createTime
        ? this.$moment(this.recordDetails.baseMsg.createTime).format(
            'YYYY-MM-DD HH:mm:ss',
          )
        : '-';
    },
    endTime() {
      return this.recordDetails.baseMsg.endTime
        ? this.$moment(this.recordDetails.baseMsg.endTime).format(
            'YYYY-MM-DD HH:mm:ss',
          )
        : '-';
    },
    chartTime() {
      return this.recordDetails.baseMsg.chartTime || 0 + '秒';
    },
    sex() {
      return this.recordDetails.userMsg.sex ? '男' : '女';
    }
  },
  created() {
  ...
  methods: {
    ...mapActions('inquiryManage', ['OlgetDetails']),
    // tab切换
    handleClick(tab) {
      const vm = this;
      vm.activeName = tab;
