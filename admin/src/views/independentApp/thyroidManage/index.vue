    ...
    <el-container>
      ...
      >
        ...
        >
          ...
          <el-table-column label="账号" prop="mobile"/>
          ...
          <el-table-column label="更新时间">
            <template slot-scope="scope">
              <span>{{
                $moment(scope.row.lastLoginDate).format("YYYY-MM-DD HH:mm")
              }}</span>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    changeTime() {
      this.filter.startTime = this.filterTime[0];
    ...
    lookDetails(id) {
      this.$router.push(
        `/independent-application/thyroid/detail/${id}`
      );
    }
  }
};
