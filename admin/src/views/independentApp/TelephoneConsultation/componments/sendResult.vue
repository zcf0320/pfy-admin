...
export default {
  ...
  methods: {
    ...mapActions('telephoneconsulation', ['getAllDepartment', 'findDrug']),
    handlerSelect(id) {
    ...
    remoteMethod(keyword) {
      ...
      if (keyword !== '') {
        this.$store
          .dispatch('telephoneconsulation/getDiseaseByName', {
            name: keyword
          })
          .then(res => {
    ...
    saveForm(refName) {
      this.$refs[refName].validate(valid => {
        ...
        this.$store
          .dispatch('telephoneconsulation/sendResult', this.formData)
          .then(() => {
