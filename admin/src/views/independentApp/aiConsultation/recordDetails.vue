          ...
          <div class="scroll-table">
            <div v-show="activeName == '0'" class="leaving-message-info">
              ...
              <div class="leaving-message-info-item">
                ...
                <div class="leaving-message-info-item-r" style="borderLeft:none">
                </div>
              </div>
...
import ChatRecordModal from '../component/chatRecordModal.vue';
import {
  operationType,
  menuType,
  diagnoseActionType,
...
export default {
  ...
  methods: {
    ...mapActions('inquiryManageFe', ['getFeDetails']),
    // tab切换
    handleClick(tab) {
      const vm = this;
      vm.activeName = tab;
