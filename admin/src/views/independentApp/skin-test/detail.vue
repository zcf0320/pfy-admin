            ...
            <div class="skin-test-detail">
                ...
                <div v-if="activeName === '1'">
                    <div class="skin-test-detail-table">
                        ...
                        <div class="skin-test-detail-table-four">
                            <div class="skin-test-detail-table-four-l">
                                <div class="skin-test-detail-label">性别</div>

                                <div class="skin-test-detail-value">
                                    {{
                                        detailInfo.userInfo.sex === 1
                                            ? "男"
                                            : "女"
                                    }}
                                </div>
                        ...
                        <div class="skin-test-detail-table-title">肤质详情</div>
...
export default {
    ...
    mounted() {
        api.getSkinTestDetail(this.$route.params.id).then(res => {
