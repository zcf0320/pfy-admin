<template>
  <div class="claim-amount flex">
    <div ref="echartDom" class="echartDom" />
    <div class="claim-amount-right">
      <div class="claim-amount-right-text top">
        理赔量
        <div class="num">{{ data.claimPolicyNum }}</div>
      </div>
      <div class="claim-amount-right-text">
        理赔率
        <div class="num">{{ data.claimPolicyRate }}%</div>
      </div>
    </div>
  </div>
</template>
...
import option from '../components/amoutLine';
export default {
  name: 'ClaimAmount',
  data() {
    return {
