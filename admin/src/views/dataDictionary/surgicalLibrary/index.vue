    ...
    <el-container>
      ...
      >
        <div class="filter-form">
          <div class="title-top">手术库</div>
          <div class="filter-box">
            <div class="search-form flex-between">
              <div class="flex-box">
                <div class="form-item">
                  <span class="label-name">手术名称:</span>
                  <el-input
                    v-model="filter.operationName"
                    placeholder="请输入手术名称"
                    class="search-input"
...
export default {
  ...
  methods: {
    ...mapActions('dataDictionary', ['getSurgicalList']),
    getList(pageInfo) {
      ...
      this.getSurgicalList(params).then((res) => {
