    ...
    save(formName) {
      ...
      vm.$refs[formName].validate(valid => {
        if (valid) {
          ...
          const data = {
            ...vm.submitInfo,
            workMorningStart: vm.submitInfo.morningWorkTime[0],
            workMorningEnd: vm.submitInfo.morningWorkTime[1],
            workAfternoonStart: vm.submitInfo.afternoonWorkTime[0],
            workAfternoonEnd: vm.submitInfo.afternoonWorkTime[1]
          };
