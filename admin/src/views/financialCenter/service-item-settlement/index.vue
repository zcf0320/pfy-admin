            ...
            <div class="filter-box">
              <div class="search-form flex-between">
                <div class="flex-box">
                  ...
                  <div class="form-item">
                    <span class="label-name">供应商ID</span>
                    <el-input
              ...
              <div class="search-form flex-between">
                <div class="flex-box">
                  ...
                  <div class="form-item">
                    ...
                    <el-select
                      v-model="filter.settlementMethod"
                      class="search-input"
                      placeholder="全部"
                      @change="search"
                    >
          ...
          <el-table v-loading="tableLoading" :data="orderList" class="table-large">
            ...
            <el-table-column label="结算方式">
              <template slot-scope="scope">
                <div class="message">
                  <div class="text">
                    {{ scope.row.settlementMethod | fliterSettle }}
                  </div>
                </div>
              </template>
            </el-table-column>
...
export default {
    ...
    btns() {
      return [
        { name: '全部', value: '' },
        {
          ...
          value: 1012,
          isNumber: true,
          number: getConfirmNumber('ServiceItemSettlement') || 0
        },
        { name: '已结算', value: 1011 }
      ];
    },
  ...
  methods: {
    ...
    addSettle() {
      this.$router.push('/settle/create');
    },
    changeTime() {
