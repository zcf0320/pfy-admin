      ...
      <div class="flex-col">
        ...
        <div class="scroll-table" v-if="activeName === '0'">
          <div class="settlement">
                ...
                <div class="details-item">
                  ...
                  <div class="contnet">
                    ...
                    <div
                      ...
                      class="item-3"
                    >
                      <div class="label">服务项别称：</div>
                      <div class="text">
                        {{ deatils.baseMsg.serviceAlias || '-' }}
                      </div>
                    </div>
                    <div class="item-3">
                    ...
                    <div class="item-3">
                      ...
                      <div class="text">
                        {{ deatils.baseMsg.settlementMethod | fliterSettle }}
                      </div>
                    </div>
                    <div class="item-3">
            ...
            >
              <div>
                <div class="span">该供应商结算的相关保单：</div>
                <div class="span mt-16 mb-16 flex-wrap">
                  <div
                    v-for="item in notSettlementPolicyNo"
                    :key="item"
                    class="policy-no"
                  >
                    {{ item }},
                ...
                <div class="fc-black">请确认是否继续结算操作</div>
              </div>
...
export default {
  ...
  computed: {
    pageAuthority() {
      return this.$store.state.user.pageAuthority['120301'];
    }
  },
  created() {
  ...
  methods: {
    ...
    confirm() {
      const notSettlementPolicyNo = sessionStorage.getItem(
        'notSettlementPolicyNo',
      );
      ...
      if (notSettlementPolicyNo) {
        this.notSettlementPolicyNo = JSON.parse(notSettlementPolicyNo);
    ...
    submitData() {
      ...
      this.confirmSettlement(data).then(() => {
        ...
        sessionStorage.removeItem('notSettlementPolicyNo');
        this.getList(this.$route.params.id);
