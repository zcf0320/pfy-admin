    ...
    <div class="el-main">
      <div class="flex-col">
        ...
        <div class="scroll-table" v-if="activeName === '0'">
          <div class="company-settlement-page">
            ...
            <div class="basisDrugsDetail-table-four-r"></div>
              ...
              <!-- <div class="basisDrugsDetail-table-four">
                <div class="basisDrugsDetail-table-four-l">
                  ...
                  <div class="basisDrugsDetail-detail basisDrugsDetail-table-two-r">
                    <div
              ...
              <div class="basisDrugsDetail-table-two">
                <div class="basisDrugsDetail-table-two-l">
                  我方结算主体
                </div>
            ...
            <Dialog
              ...
              @closed="close"
            >
              <div class="sure-settlement-dialog">
                请认真核对以下信息：
              </div>
              ...
              <div class="sure-settlement-dialog-item">
                保险产品名称：{{ settlementObj.productName || '-' }}
              </div>
              <div class="sure-settlement-dialog-item">
                汇款凭证:
              </div>
            ...
            <div class="page-footer">
              ...
              >
              <el-button
                v-if="pageAuthority.includes('edit') && !saveState"
                type="primary"
        ...
        <div class="scroll-table mt-24" v-if="activeName === '1'">
          <Logs :id="$route.params.id" type="110"></Logs>
        </div>
        <div class="scroll-table mt-24" v-if="activeName === '2'">
            <UploadInvoice :showUpload="pageAuthority.includes('upload')" :settlementId="$route.params.id"></UploadInvoice>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    changeRemark() {
      if (this.editState) {
        ...
        this.$store
          .dispatch('insuranceCompany/setPolicySettlementMessage', {
    ...
    save() {
      this.$store
        .dispatch('insuranceCompany/setPolicySettlementDetail', {
          id: this.$route.params.id,
    ...
    getData() {
      this.$store
        .dispatch('insuranceCompany/getBillDetail', {
          id: this.$route.params.id
        })
        .then(res => {
          if (res.data) {
