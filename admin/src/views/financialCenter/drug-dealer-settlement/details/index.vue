        ...
        <div class="content">
          <div class="table">
            <el-table v-loading="tableLoading" :data="workOrderList" class="table-large">
              ...
              <el-table-column label="供应商信息" show-overflow-tooltip>
                <template slot-scope="scope">
                  <div class="box">
              ...
              <el-table-column label="结算金额" width="90px">
                <template slot-scope="scope">
                  <div class="box">￥{{ scope.row.settlementPrice }}</div>
                </template>
              </el-table-column>
              <el-table-column label="运费" width="90px">
                <template slot-scope="scope">
                  <div class="box"
                    >￥{{ scope.row.settlementMedicineInfoVO.postage }}</div
                  >
                </template>
              </el-table-column>
              <el-table-column label="处方费" width="90px">
                <template slot-scope="scope">
                  <div class="box"
                    >￥{{
                      scope.row.settlementMedicineInfoVO.prescription
                    }}</div
                  >
                </template>
              </el-table-column>
              <el-table-column label="药品金额" width="90px">
                <template slot-scope="scope">
                  <div class="box"
                    >￥{{ scope.row.settlementMedicineInfoVO.unitPrice }}</div
                  >
                </template>
              </el-table-column>
...
export default {
  ...
  computed: {
    ...
    pageAuthority() {
      return this.$store.state.user.pageAuthority['12030202'];
    }
  },
  created() {
  ...
  methods: {
    ...
    // 查看详情
    lookDeatils(row) {
      this.$router.push(`drug-dealer-settlement-details/detail/${row.id}`);
    },
    getOption(code) {
      // 账期  结算状态
      this.$store
