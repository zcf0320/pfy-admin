    ...
    <div class="el-main">
      <div class="flex-col">
          ...
          <div class="company-settlement-page">
            ...
            <div class="basisDrugsDetail-table">
              ...
              <div class="basisDrugsDetail-table-four">
                ...
                <div class="basisDrugsDetail-table-four-r">
                  <div class="basisDrugsDetail-type">服务项编号</div>

                  <div class="basisDrugsDetail-detail">
                    {{ settlementObj.serviceItemCode || '-' }}
                  </div>
                </div>
              </div>
              <div class="basisDrugsDetail-table-four">
                <div class="basisDrugsDetail-table-four-l">
                  <div class="basisDrugsDetail-type">服务项名称</div>

                  <div class="basisDrugsDetail-detail">
                    {{ settlementObj.serviceItemName || '-' }}
                  </div>
                </div>
                <div class="basisDrugsDetail-table-four-r">
              ...
              <div class="basisDrugsDetail-table-four">
                ...
                <div class="basisDrugsDetail-table-four-r">
                  ...
                  <div class="basisDrugsDetail-detail">
                    {{
                      settlementObj.settlementStatus
                        ? $moment(settlementObj.updateTime).format(
                            'YYYY-MM-DD HH:mm:ss',
                          )
                        : '-'
                    }}
              ...
              <div class="basisDrugsDetail-table-four">
                <div class="basisDrugsDetail-table-four-l">
                  <div class="basisDrugsDetail-type">保险公司编号</div>
                ...
                <div class="basisDrugsDetail-table-two-r">
                  ...
                  <div class="basisDrugsDetail-img-list">
                    <div class="basisDrugsDetail-img-list-item">
                      ...
                      <el-upload
                        v-if="!saveState && headPic && headPic.length < 9"
            ...
            <Dialog
              ...
              @closed="close"
            >
              <div class="sure-settlement-dialog">请认真核对以下信息：</div>
              <div class="sure-settlement-dialog-item">
                账期：{{ settlementObj.settlementMonth || '-' }}
              </div>
              <div class="sure-settlement-dialog-item">
                结算金额：￥{{ settlementObj.sumMoney || '-' }}
              </div>
              <div class="sure-settlement-dialog-item">
                保险公司名称：{{ settlementObj.companyName || '-' }}
              </div>
              <div class="sure-settlement-dialog-item">
                承保机构：{{ settlementObj.bankNumber || '-' }}
              </div>
              <div class="sure-settlement-dialog-item">汇款凭证:</div>
              <div class="basisDrugsDetail-img-list">
                <div class="basisDrugsDetail-img-list-item">
                  <div
                    v-for="(item, index) in headPic || []"
              ...
              <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click.native.prevent="save"
                  >确定</el-button
                >
              </span>
            </Dialog>
            <div class="page-footer">
              ...
              >
              <el-button
                v-if="!saveState && pageAuthority.includes('edit')"
                type="primary"
                @click.native.prevent="sureSettlement"
              >
                确认结算
              </el-button>
            </div>
        ...
        <div class="scroll-table mt-24" v-if="activeName === '1'">
          <Logs :id="$route.params.id" type="111"></Logs>
        </div>
         <div class="scroll-table mt-24" v-if="activeName === '2'">
            <UploadInvoice :settlementId="$route.params.id"></UploadInvoice>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    pageAuthority() {
      return this.$store.state.user.pageAuthority['120202'] || [];
    }
  },
  created() {
    this.getData();
  ...
  methods: {
    ...
    changeRemark() {
      if (this.editState) {
        ...
        this.$store
          .dispatch('supplier/setCompanySettlementMessage', {
    ...
    toSettlementDetail() {
      ...
      this.$router.push('/financial-center/claim-settlement-details');
    },
    save() {
      this.settlementObj.settlementMainRatioList.forEach(item => {
        if (!item.ratioNumber) {
          item.ratioNumber = 0;
        }
      });
      this.$store
        .dispatch('supplier/setCompanySettlementDetail', {
          id: this.$route.params.id,
    ...
    getData() {
      this.$store
        .dispatch('supplier/getCompanySettlementDetail', {
          id: this.$route.params.id
        })
        .then(res => {
          if (res.data) {
