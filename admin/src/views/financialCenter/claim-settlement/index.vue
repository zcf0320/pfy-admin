      ...
      >
                ...
                <div class="flex-box">
                  ...
                  <div class="form-item">
                    ...
                    <el-select
                      ...
                      @change="search"
                    >
                      <el-option label="按权益使用次数" :value="1"/>
                      <el-option label="按保单销售数量" :value="2"/>
                      <el-option label="按订单实际金额" :value="3"/>
                    </el-select>
                  </div>
                  <div class="form-item">
        ...
        <div class="work-data">
          <div class="work-data-l">
            <div class="item">
              ...
              <div class="data-text">
                <div class="label">{{ statisticsData.billNum || '0' }}</div>
            ...
            <div class="item">
              ...
              <div class="data-text">
                <div class="label">
                  {{ statisticsData.completedBillNum || '0' }}
                </div>
            ...
            <div class="item">
              ...
              <div class="data-text">
                <div class="label">
                  {{ statisticsData.pendingBillNum || '0' }}
                </div>
        ...
        <div class="card">
          ...
          >
            ...
            <el-table-column label="服务项信息">
              <template slot-scope="scope">
                <div class="message">
                  <div class="text">{{ scope.row.serviceItemName }}</div>
                  <div class="table-sectext">
                    {{ scope.row.serviceItemCode }}
                  </div>
                </div>
              </template>
            </el-table-column>
...
export default {
    ...
    btns() {
      return [
        { name: '全部', value: '' },
        {
          ...
          value: '0',
          isNumber: true,
          number: getConfirmNumber('ClaimSettlement') || 0
        },
        { name: '已结算', value: '1' }
      ];
    },
  ...
  methods: {
    ...
    getList(pageInfo) {
      ...
      // 查询列表
      vm.getCompanySettlementList(params)
        .then(res => {
      ...
      // 查询统计数据
      this.getSettlementStatistics(params).then(res => {
    ...
    lookDetails(id) {
      ...
      this.$router.push(`/financial-center/claim-settlement/detail/${id}`);
    },
    search() {
    ...
    toSettlementDetail() {
      this.$router.push('claim-settlement-details');
    }
  }
};
</script>
