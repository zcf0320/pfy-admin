import * as inquiryManageApi from '@/api/inquiryManage';
...
const actions = {
  ...
  // 获取在线问诊详情
  OlgetDetails(ctx, params) {
    return inquiryManageApi.OlgetDetails(params);
  },
  // 获取问诊过程
  ...
  addCountCommonWord(ctx, params) {
   ...
   // 获取人工问诊详情
   getWorkOrderDetails(ctx, params) {
    return inquiryManageApi.getWorkOrderDetails(params);
  }
};
